  ...
  return (
    ...
    >
      ...
      >
        ...
        <path d="M12.04 2.5A9.5 9.5 0 0 0 3.9 16.86L2.5 21.5l4.75-1.25A9.5 9.5 0 1 0 12.04 2.5zm0 17.36c-1.5 0-2.96-.4-4.24-1.16l-.3-.18-2.82.74.75-2.75-.2-.32a7.86 7.86 0 1 1 7.01 3.87z" />
      </svg>
    </a>
  );
}
